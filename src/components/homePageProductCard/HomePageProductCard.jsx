    ...
    <div className="min-h-screen bg-black py-16 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold text-white mb-4 tracking-wide">Featured Products</h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            Discover our handpicked collection of premium products crafted with excellence
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="group relative bg-gradient-to-r from-[#C2985C] to-[#C2985C]/80 text-white px-12 py-4 rounded-2xl font-bold text-lg transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-2 overflow-hidden"
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
              View All Products
